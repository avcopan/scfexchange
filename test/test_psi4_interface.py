...
def test__frozen_core():
    ...
    assert (
        np.allclose(valence_energy, -37.824261813733628, rtol=1e-09,
                    atol=1e-10))
...
def test__mp2():
    ...
    assert (
        np.allclose(correlation_energy, -0.153359695359343, rtol=1e-09,
                    atol=1e-10))
...
def test__mp2_frozen_core():
    ...
    assert (
        np.allclose(correlation_energy, -0.151178068916734, rtol=1e-09,
                    atol=1e-10))
