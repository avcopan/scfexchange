...
def test__get_mo_slice():
  ...
  assert(orbitals.get_mo_slice(mo_type = 'spinor', mo_block = 'o'  ) == slice(2, 7, None)      )
  assert(orbitals.get_mo_slice(mo_type = 'spinor', mo_block = 'v'  ) == slice(7, None, None)   )
  assert(orbitals.get_mo_slice(mo_type = 'spinor', mo_block = 'co' ) == slice(None, 7, None)   )
  ...
  assert(orbitals.get_mo_slice(mo_type = 'alpha', mo_block = 'o'   ) == slice(1, 4, None)      )
  assert(orbitals.get_mo_slice(mo_type = 'alpha', mo_block = 'v'   ) == slice(4, None, None)   )
  assert(orbitals.get_mo_slice(mo_type = 'alpha', mo_block = 'co'  ) == slice(None, 4, None)   )
  ...
  assert(orbitals.get_mo_slice(mo_type = 'beta', mo_block = 'o'    ) == slice(1, 3, None)      )
  assert(orbitals.get_mo_slice(mo_type = 'beta', mo_block = 'v'    ) == slice(3, None, None)   )
  assert(orbitals.get_mo_slice(mo_type = 'beta', mo_block = 'co'   ) == slice(None, 3, None)   )
...
def test__get_mo_energies():
  ...
  assert(orbitals.get_mo_energies(mo_type = 'spinor', mo_block = 'o'  ).shape == (5,) )
  assert(orbitals.get_mo_energies(mo_type = 'spinor', mo_block = 'v'  ).shape == (41,))
  assert(orbitals.get_mo_energies(mo_type = 'spinor', mo_block = 'co' ).shape == (7,) )
  ...
  assert(orbitals.get_mo_energies(mo_type = 'alpha', mo_block = 'o'   ).shape == (3,) )
  assert(orbitals.get_mo_energies(mo_type = 'alpha', mo_block = 'v'   ).shape == (20,))
  assert(orbitals.get_mo_energies(mo_type = 'alpha', mo_block = 'co'  ).shape == (4,) )
  ...
  assert(orbitals.get_mo_energies(mo_type = 'beta', mo_block = 'o'    ).shape == (2,) )
  assert(orbitals.get_mo_energies(mo_type = 'beta', mo_block = 'v'    ).shape == (21,))
  assert(orbitals.get_mo_energies(mo_type = 'beta', mo_block = 'co'   ).shape == (3,) )
...
def test__get_mo_coefficients():
  ...
  assert(orbitals.get_mo_coefficients(mo_type = 'spinor', mo_block = 'o'  ).shape == (48, 5) )
  assert(orbitals.get_mo_coefficients(mo_type = 'spinor', mo_block = 'v'  ).shape == (48, 41))
  assert(orbitals.get_mo_coefficients(mo_type = 'spinor', mo_block = 'co' ).shape == (48, 7) )
  ...
  assert(orbitals.get_mo_coefficients(mo_type = 'alpha', mo_block = 'o'   ).shape == (24, 3) )
  assert(orbitals.get_mo_coefficients(mo_type = 'alpha', mo_block = 'v'   ).shape == (24, 20))
  assert(orbitals.get_mo_coefficients(mo_type = 'alpha', mo_block = 'co'  ).shape == (24, 4) )
  ...
  assert(orbitals.get_mo_coefficients(mo_type = 'beta', mo_block = 'o'    ).shape == (24, 2) )
  assert(orbitals.get_mo_coefficients(mo_type = 'beta', mo_block = 'v'    ).shape == (24, 21))
  assert(orbitals.get_mo_coefficients(mo_type = 'beta', mo_block = 'co'   ).shape == (24, 3) )
